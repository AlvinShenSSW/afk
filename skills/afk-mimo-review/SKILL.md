...
description: "afk-mimo-review: Part of the afk pipeline. Independent read-only MiMo review, an optional external role. Triggers include \"/afk-mimo-review\", \"run mimo review\", and \"MiMo external gate\"."
---
...
`mimo-gate.mjs` beside this skill and bootstrap when needed.
...
verdict; record it and follow [external review](../afk/references/external-review.md) for fallback.
