...
import {
  chmodSync, existsSync, mkdtempSync, readdirSync, rmSync, writeFileSync,
} from 'node:fs';
...
// Windows rules are exercised on every OS; `path.win32.join` in production
// means the candidate strings here are the strings production builds.
