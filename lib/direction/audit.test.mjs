...
import { prepareAudit, checkAudit, observeTarget, validatePacket, validateModelResult,
  extractModelResult, validateDerivation, requestBody, profileFingerprint, validateQualification, RUNTIME_FILES, terminalRequest, loadPrepared, LIMITS as AUDIT_LIMITS } from './audit.mjs';
...
async function historicalFixture(t, { oldProfile = false, legacyRequest = false, historicalId = 'implementation' } = {}) {
