...
import { decodeNativeRequest, decodeNativeResponse, wireBound, nativeDeclarationDigest, checkNativeRelease, nativeJsonBytes } from './native-wire.mjs';
  ...
  async function handle(req,res) {
    ...
    try {
      ...
      responseBody=await Promise.race([cancelled,(async()=>{
        ...
        context.observation=decodeNativeResponse(responseBytes,{maxBytes,responseMetadata:context.responseMetadata,requestedModel:decoded.model});
