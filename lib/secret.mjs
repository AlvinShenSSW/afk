...
const RULES = [
  ...
  // JWTs: two mandatory base64url segments, optional signature (`alg:none`
  // ends in a dot). Sits before the 64-hex rule so a hex signature cannot be
  // pre-mangled into two half-redactions.
